...
-- Desafio - Relatório todos os dados dos pedidos dados dos itens nome do cliente e nome das pizzas

SELECT * FROM Pedidos INNER JOIN Itens_Pedido ON Pedidos.pedido_id = Itens_Pedido.pedido_id INNER JOIN Clientes ON cliente_id = Itens_Pedido.pedido_id
