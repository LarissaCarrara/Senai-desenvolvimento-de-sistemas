...
const enviarProdutoAosSalvos = (produto) => {
    produtos.push(produto)
    const strProdutos = JSON.stringify(produtos)
    window.localStorage.setItem("produtos", strProdutos)
}
                ...
                <FlatList
                    ...
                    renderItem={({ item }) => {
                        ...
                        return (
                            <TouchableOpacity
                                onPress={() => {
                                    enviarPrecoAoCarrinho(20)
                                    enviarProdutoAosSalvos({produto:"produto", preco: 20})
                                }}
